...
import { Nav, NavItem, NavLink, Progress, TabContent, TabPane, ListGroup, ListGroupItem, Label, Input, FormGroup } from 'reactstrap';
  ...
  render() {
    ...
    return (
      ...
      <div className="p-3">
        <div className="mb-3">
          <h5>Exchanges</h5>
          <Input type="select" name="aside_exchange_list" id="aside_exchange_list">
