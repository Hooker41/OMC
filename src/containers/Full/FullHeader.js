          ...
          <AppHeaderDropdown direction="down">
            ...
            <DropdownMenu right style={{ right: 'auto' }}>
              ...
              <DropdownItem><i className="fa fa-shield"></i> Lock Account</DropdownItem> */}
              {
                ...
                (isLoggedIn()) ? (<DropdownItem onClick={() => logout()} ><i className="fa fa-lock"></i> Logout</DropdownItem>)
                :(<DropdownItem onClick={() => login()} ><i className="fa fa-lock"></i> Login</DropdownItem>)
              }
            </DropdownMenu>
          </AppHeaderDropdown>
        </Nav>
